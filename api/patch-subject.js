...
const NEW_SUBJECT = "Please Fill Out Your Waiver Before Tonight's Event";

/**
 * ONE-TIME: update only the `subject` field of the Indiana day-of reminder,
 * leaving body/okToSend/dirBcc/etc. untouched. Idempotent, passcode-protected.
 * Delete after use.
 */
